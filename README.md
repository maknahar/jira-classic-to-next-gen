...
### Limitations
- When you migrate an issue via Jira, you get a symlink created from old issue to new issue. i.e. Clicking on old card link will take you to new one. Unfortunately this is not supported by Jira REST API. 
